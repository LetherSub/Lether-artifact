...
typedef struct
{
  ...
  const unsigned int length_m;

  const unsigned int length_h;

  const unsigned int add_ARP;

  const unsigned int bit_proof;

  const unsigned int nRec;

  const unsigned int bit_index;

  const unsigned int bit_length;

  const unsigned int mes_index;

  const unsigned int mp_index;

  const unsigned int bin_h_index;

  const unsigned int bin_m_index;

  const int64_t sf_bal;

  const int64_t beta_m;

  const unsigned int bin_bal_index;
...
typedef struct
{
  ...
  add_lnp_tbox_params_srcptr add_param;
